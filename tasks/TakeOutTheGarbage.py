...
class Task():
    ...
    def __init__(self):        
        ...
        # actions.head("",2.5)
        # actions.goto('before_door')
        # actions.move('foward', seconds=4.0)
        actions.goto('search_bin1')
        aux = False
        actions.talk("Looking for a trash!")
        coordinates = 0
        while not aux:
            coordinates = actions.specific_object('trash')
