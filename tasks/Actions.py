...
class Actions():
    ...
    def lugar_vazio(self, guest1, guest2, guest3):
        ...
        if 0 <= guest1 < (1/num_lugares * 640) or 0 <= guest2 < (1/num_lugares * 640) or 0 <= guest3 < (1/num_lugares * 640):
            seat1 = True

        if (2/num_lugares * 640) < guest1 <  (3/num_lugares * 640) or (2/num_lugares * 640) < guest2 <  (3/num_lugares * 640) or  (2/num_lugares * 640) < guest3 <  (3/num_lugares * 640):
            seat3 = True

        if (3/num_lugares * 640) < guest1 <  (4/num_lugares * 640) or (3/num_lugares * 640) < guest2<  (4/num_lugares * 640) or  (3/num_lugares * 640) < guest3 <  (4/num_lugares * 640):
            seat4 = True
    ...
    def click(self):
        wav_file = AudioSegment.from_file(file = "/home/robofei/catkin_hera/src/3rdParty/vision_system/audio.wav",  format = "wav")  
        play(wav_file)
